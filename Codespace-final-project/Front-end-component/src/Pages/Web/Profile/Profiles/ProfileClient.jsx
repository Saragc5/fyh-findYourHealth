      ...
      <div className={styles.containerProfile} >
        ...
        <form className={styles.profileForm}
          ...
          <span className={clicked && window.innerWidth <= 400 ? styles.detailsDBClickedIphone : clicked && window.innerWidth >= 400 ? styles.detailsDBClicked : styles.detailsDB}>{!userProfile.userDB.lastname ? "" : userProfile.userDB.lastname}</span>
            ...
            <div className={clicked && window.innerWidth <= 400 ? styles.blockDetailsClickedIphone : styles.blockDetails}>
              <label className={clicked && window.innerWidth <= 400 ? styles.labelDBClickedIphone : clicked && window.innerWidth >= 400 ? styles.labelDBClicked : styles.labelDB}>Date of birth:</label>
              <span className={clicked && window.innerWidth <= 400 ? styles.detailsDBClickedIphone : clicked && window.innerWidth >= 400 ? styles.detailsDBClicked : styles.detailsDB} >{!userProfile.userDB.dateOfBirth ? "" : userProfile.userDB.dateOfBirth}</span>
              <input className={clicked && window.innerWidth <= 400 ? styles.inputClickedIphone : clicked && window.innerWidth >= 400 ? styles.input : styles.detailsDB} name="dateOfBirth" type="text" autoComplete="user-dateOfBirth"
                placeholder="type here to edit" onChange={handleInput} />
            </div>
            <div className={clicked && window.innerWidth <= 400 ? styles.blockDetailsClickedIphone : styles.blockDetails}>
          ...
          <div className={clicked && window.innerWidth <= 400 ? styles.blockDetailsClickedIphone : styles.blockDetails}>
              <label  className={clicked && window.innerWidth <= 400 ? styles.labelDBClickedIphone : clicked && window.innerWidth >= 400 ? styles.labelDBClicked : styles.labelDB}>Telephone:</label>
              <span className={clicked && window.innerWidth <= 400 ? styles.detailsDBClickedIphone : clicked && window.innerWidth >= 400 ? styles.detailsDBClicked : styles.detailsDB}>{!userProfile.userDB.phoneNumber ? "" : userProfile.userDB.phoneNumber}</span>
              <input className={clicked && window.innerWidth <= 400 ? styles.inputClickedIphone : clicked && window.innerWidth >= 400 ? styles.input : styles.detailsDB} name="phoneNumber" type="text" autoComplete="user-phoneNumber"
                placeholder="type here to edit" onChange={handleInput} />
            </div>
